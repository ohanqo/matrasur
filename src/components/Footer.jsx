            ...
            <div className="o-footer -fw -hh">
                <div className="o-footer__columns -white">
                    <div className="o-footer__column">
                        ...
                        <div className="o-footer__column--tel">
                            +33 1 61 61 65 65
                        </div>
                        ...
                        <div className="o-footer__column--social">
                            <img src="/assets/img/icon/youtube.svg" alt="Chaîne YouTube Matrasur Composite" />
                            <img src="/assets/img/icon/facebook.svg" alt="Page Facebook Matrasur Composite" />
                        </div>
                    </div>
                    <div className="o-footer__column">
                        <ul>
                            <li className="o-footer__column--title">Domaines d'application</li>
                            <li>Lorem ipsum</li>
                        </ul>
                        <ul>
